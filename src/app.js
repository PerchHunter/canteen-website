import "./project/commonStyles.scss"; // подключение шрифтов и общих стилей
import "./project/header/header.scss";
import "./project/header/telephone-dropdown/telephone-dropdown.scss";
import "./project/upper-menu/upper-menu.scss";
...
import "./project/recomendations/recomendations.scss";
import "./project/about-us/about-us.scss";
import "./project/footer/footer.scss";
import "./project/footer/footer-accordion/footer-accordion.scss"; // аккордион футера для мобильной версии
